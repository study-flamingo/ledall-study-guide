# Void Terminology Correction Plan
...
- Weight transfers to the new rear position
- Creates distance from opponent
- Often performed *while* executing a cut (e.g., "downright stroke voiding back the left leg")

**German Equivalent:** *Weichen* (yielding), passing backward
...
### Category B: Practitioner Tips Corrections
...
This means: execute a quarter cut, then pass a foot backwards, then assume your stop guard.
...
### 4. Dragon's Tail with Pendant (Session 4)
